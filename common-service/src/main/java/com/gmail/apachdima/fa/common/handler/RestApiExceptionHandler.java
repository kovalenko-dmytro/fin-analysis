package com.gmail.apachdima.fa.common.handler;

import com.gmail.apachdima.fa.common.constant.common.CommonConstant;
...
public class RestApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        ErrorResponseDTO responseDTO = buildRestApiErrorResponse(message, HttpStatus.BAD_REQUEST, errors);
    ...
    @ExceptionHandler({FinAnalysisApplicationException.class})
    public ResponseEntity<Object> handleGeneralExceptions(FinAnalysisApplicationException ex) {
        ErrorResponseDTO responseDTO =
    ...
    private ResponseEntity<Object> createResponseEntity(ErrorResponseDTO responseDTO) {
        return new ResponseEntity<>(responseDTO, new HttpHeaders(), responseDTO.status());
    }

    private ErrorResponseDTO buildRestApiErrorResponse(String exceptionMessage, HttpStatus httpStatus, List<String> errors) {
