package com.gmail.apachdima.fa.notification.email.service.impl;

import com.gmail.apachdima.fa.notification.email.repository.EmailLogRepository;
import com.gmail.apachdima.fa.notification.email.service.EmailService;
...
import com.gmail.apachdima.fa.common.dto.email.SendEmailContextDTO;
import com.gmail.apachdima.fa.common.exception.FinAnalysisApplicationException;
import com.gmail.apachdima.fa.notification.email.mapper.EmailMapper;
...
public class EmailServiceImpl implements EmailService {
    ...
    private void sendPreparedEmail(SendEmailContextDTO context, Locale locale) {
        ...
        try {
            ...
            throw new FinAnalysisApplicationException(messageSource.getMessage(Error.EMAIL_SEND_ERROR.getKey(), params, locale));
        }
    }
